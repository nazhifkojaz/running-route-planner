...
import { closeExplorePanel, openExplorePanel, setupExplorePanel } from '../panels/explorePanel';
import { closeMyRoutesPanel, openMyRoutesPanel, setupMyRoutesPanel } from '../panels/myRoutesPanel';
import { openSaveRoutePanel, setupSaveRoutePanel } from '../panels/saveRoutePanel';
import { closeSearchPanel, openSearchPanel, setupSearchPanel } from '../panels/searchPanel';
import { closeUserPanel, initAccountIcon, openUserPanel } from '../panels/userPanel';
...
export async function bootstrapApp() {
  ...
  const loadMyRoutes = setupMyRoutesPanel(dom.myRoutesPanel, dom.backdrop, map, routeManager);
